...
class chatBot:
    ...
    def get_account_info(self, input):
        api_url = "https://api.funtranslations.com/translate/yoda.json?text={}".format(
            input
        )
    ...
    def command(self, input):
        if input.lower() == "!! about" or input.lower() == "!!about":
            ...
            return (
                "Command not recognized. Please try one of these: !! [about|help|yoda]"
            )
