...
<head>
    ...
    <title>Coverage for /home/ec2-user/.local/lib/python3.6/site-packages/engineio/exceptions.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/home/ec2-user/.local/lib/python3.6/site-packages/engineio/exceptions.py</b> :
...
<div id="source">
    <p id="t1" class="run"><span class="n"><a href="#t1">1</a></span><span class="t"><span class="key">class</span> <span class="nam">EngineIOError</span><span class="op">(</span><span class="nam">Exception</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t5" class="run"><span class="n"><a href="#t5">5</a></span><span class="t"><span class="key">class</span> <span class="nam">ContentTooLongError</span><span class="op">(</span><span class="nam">EngineIOError</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t9" class="run"><span class="n"><a href="#t9">9</a></span><span class="t"><span class="key">class</span> <span class="nam">UnknownPacketError</span><span class="op">(</span><span class="nam">EngineIOError</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t13" class="run"><span class="n"><a href="#t13">13</a></span><span class="t"><span class="key">class</span> <span class="nam">QueueEmpty</span><span class="op">(</span><span class="nam">EngineIOError</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t17" class="run"><span class="n"><a href="#t17">17</a></span><span class="t"><span class="key">class</span> <span class="nam">SocketIsClosedError</span><span class="op">(</span><span class="nam">EngineIOError</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    ...
    <p id="t21" class="run"><span class="n"><a href="#t21">21</a></span><span class="t"><span class="key">class</span> <span class="nam">ConnectionError</span><span class="op">(</span><span class="nam">EngineIOError</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
